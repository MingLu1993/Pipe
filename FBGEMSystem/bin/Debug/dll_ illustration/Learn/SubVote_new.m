function sub_predictVote = SubVote_new( t,subtree , sample ,Beta,discrete_dim, targetsNum)
...
%   返回各样本的预测
    ...
    for j=1:AllNum
        ...
        for i=1:t
            sub_predictVote_array(predict(i,j))=sub_predictVote_array(predict(i,j))+log(1/Beta(i));
        end
